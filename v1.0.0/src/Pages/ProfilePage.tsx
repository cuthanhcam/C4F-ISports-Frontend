...
const ProfilePage = () => {
  ...
  const handleAvatarSuccess = () => {
    fetchUserProfile(); // Cập nhật lại thông tin user sau khi upload
    alert("Cập nhật avatar thành công!"); // Thêm thông báo thành công
  };
  ...
  return (
    <div>
              ...
              <div className="grid grid-cols-[auto_1fr] gap-16">
                ...
                <div>
                  <div className="flex flex-col gap-8">
                    <div 
                      onClick={() => setSelectSetting('Thông tin cá nhân')}
                    ...
                    <div 
                      onClick={() => setSelectSetting('Cài đặt bảo mật')}
                      className="flex items-center gap-2 py-4 px-8 bg-slate-100 rounded-full hover:-translate-y-1.5 duration-300 transition-transform ease-in-out cursor-pointer"
                    >
                      <div className="bg-btn-primary p-2 rounded-full">
                ...
                {/* Thông tin chức năng */}
                {selectSetting === 'Thông tin cá nhân' ? (
                  <div>
                  <div className="flex justify-between pb-10">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <img 
                        src={user?.avatarUrl || avatarDefault} // Sử dụng avatar của user, nếu không có thì dùng avatarDefault
                        alt="User avatar" 
                        className="w-14 h-14 object-cover rounded-full"
                      />
                      <button 
                        onClick={() => setOpenUploadAvatar(true)}
                        className="px-4 py-2 bg-btn-primary text-white rounded-md hover:bg-blue-700"
                      >
                        Cập nhật Avatar
                      </button>
                    </div>
                      ...
                      <div className="p-8">
                        ...
                        <div className="flex justify-end pt-4">
                          <button 
                            ...
                            className="px-8 py-2 rounded-sm bg-btn-primary text-sm font-medium cursor-pointer"
                          >
                            Thay đổi mật khẩu
                          </button>
                        </div>
                    ...
                    <div className="bg-slate-100 rounded-md mt-8">
                      <div className="p-8">
                        ...
                        <p className="text-sm font-light py-4">
                          Xóa tài khoản của bạn và tất cả thông tin liên quan đến tài khoản của bạn như trang hồ sơ. 
                          Xin lưu ý rằng tất cả dữ liệu sẽ bị mất vĩnh viễn nếu bạn xóa tài khoản của mình.
                        </p>
                        <div className="flex justify-end pt-4">
                          <button 
        ...
        <div className="fixed inset-0 bg-black/10 backdrop-blur-sm flex items-center justify-center z-[999]">
          <div className="bg-slate-100 bg-opacity-100 p-14 rounded-lg shadow-lg w-md relative">
            ...
            <div className="flex justify-center pb-8">
              <img 
                src={user?.avatar || avatarDefault} // Sử dụng avatar của user nếu có
                alt="User avatar" 
                className="w-14 h-14 object-cover rounded-full"
              />
            </div>
            ...
            <div className="flex items-center justify-end pt-8">
              <button 
                ...
                className="px-12 py-2 bg-btn-primary rounded-md text-sm font-medium cursor-pointer"
              >
                Lưu
              </button>
            </div>
      ...
      {openUploadAvatar && (
        <UploadAvatar 
          onClose={() => setOpenUploadAvatar(false)}
