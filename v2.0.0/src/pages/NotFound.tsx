    ...
    return (
        <div className="bg-surface min-h-screen flex items-center justify-center">
            ...
            bg-surface-2 shadow-navigation p-6 rounded-3xl">
                ...
                <Link to='/' className="bg-primary px-4 py-2 rounded-md text-base font-bold 
                hover:bg-primary-shade hover:no-underline duration-200 transition-all">Go Back Home</Link>
            </div>
        </div>
    )
}
