...
//   return (
//     <div className="fixed inset-0 bg-black/70 z-50 backdrop-blur-md flex items-center justify-center p-4 sm:p-2">
//       <div className="mx-auto w-full max-w-4xl sm:max-w-md md:max-w-lg lg:max-w-4xl">
//         <div className="w-full bg-surface-2 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row transform transition-all">
//           {/* Image */}
...
//                 src=""
//                 alt="Logo"
//                 className="w-12 h-12 mr-3 sm:w-10 sm:h-10"
//               />
...
//             {/* Close button */}
//             <button
//               className="absolute top-4 right-4 sm:top-3 sm:right-3 text-surface-on hover:text-primary-default transition-colors"
//               onClick={() => {
//                 setShowPageLogin(false);
//                 setShowPageRegister(false);
...
//             {/* Title */}
//             <div className="items-center mb-4 sm:mb-3">
...
//             {/* Form */}
//             <form className="space-y-4 sm:space-y-3" onSubmit={handleSubmit}>
//               {/* Tên hiển thị */}
//               <div>
//                 <label
//                   htmlFor="email"
...
//                   className="w-full px-4 py-2 sm:px-3 sm:py-1.5 bg-surface-3 text-white rounded-md border border-outline-default focus:outline-none focus:ring-2 focus:ring-primary-default transition"
...
//                     className="w-full px-4 py-2 sm:px-3 sm:py-1.5 bg-surface-3 text-white rounded-md border border-outline-default focus:outline-none focus:ring-2 focus:ring-primary-default transition pr-12 sm:pr-10"
//                     placeholder="Mật khẩu"
//                   />
//                   <button
//                     type="button"
//                     className="absolute right-3 sm:right-2 top-1/2 transform -translate-y-1/2 text-white hover:text-primary-default"
//                     onClick={handleShowPassword}
//                   >
//                     {showPassword ? (
//                       <MdOutlineRemoveRedEye className="text-xl sm:text-lg" />
//                     ) : (
//                       <FaRegEyeSlash className="text-xl sm:text-lg" />
//                     )}
//                   </button>
//                 </div>
//               </div>
...
//               <button
//                 type="submit"
//                 className="w-full bg-primary text-surface-variant py-2 sm:py-1.5 px-4 mt-10 sm:mt-6 rounded-md font-medium hover:bg-primary-shade transition duration-200 shadow-lg"
