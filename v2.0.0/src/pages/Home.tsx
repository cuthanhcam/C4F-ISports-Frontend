            ...
            <div className="flex flex-col items-center justify-center my-12 md:my-20">
              ...
              <div className="w-full max-w-4xl bg-surface-1 dark:bg-dark-surface-1 p-6 rounded-3xl shadow-navigation dark:shadow-navigation-dark border border-outline-variant dark:border-dark-outline-variant">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <button className="flex items-center justify-center gap-2 bg-primary dark:bg-dark-primary font-medium hover:bg-primary-inverse dark:hover:bg-dark-primary-shade duration-200 transition-all ease-in-out py-3 px-6 rounded-lg text-surface-on dark:text-dark-primary-on">
                    <FaSearch />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {homeFeaturedFields.map((field) => (
                  ...
                  >
                    ...
                    <div className="absolute top-4 right-4 bg-primary dark:bg-dark-primary font-medium hover:bg-primary-inverse dark:hover:bg-dark-primary-shade duration-200 transition-all ease-in-out text-sm py-1 px-3 rounded text-surface-on dark:text-dark-primary-on">
                      {field.sportType}
                    </div>

                    {/* Thông tin sân */}
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      <h3 className="text-lg text-surface-on dark:text-dark-surface-on font-medium mb-2">{field.name}</h3>
                      ...
                      <button className="w-full py-2 rounded-3xl bg-primary dark:bg-dark-primary font-medium hover:bg-primary-inverse dark:hover:bg-dark-primary-shade duration-200 transition-all ease-in-out text-surface-on dark:text-dark-primary-on">
                        Đặt sân ngay
                      </button>
                    </div>
                  </div>
            ...
            <div className="my-12 md:my-20 bg-gradient-to-r from-primary-shade dark:from-dark-primary-shade to-primary-container dark:to-dark-primary-container rounded-3xl py-12 px-8 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-4">
                  <a
                    href="/register"
                    className="py-3 px-8 rounded-lg bg-primary dark:bg-dark-primary font-medium hover:bg-primary-inverse dark:hover:bg-dark-primary-shade duration-200 transition-all ease-in-out shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 text-surface-on dark:text-dark-primary-on"
                  >
                    Đăng ký ngay
                  </a>
                </div>
