    ...
    <Layout>
      <div className="bg-surface relative">
        ...
        <div className="container py-6 relative z-[0]">
          ...
          {/* Hero Content */}
          <div className="flex flex-col items-center justify-center py-16 md:py-24 lg:py-28">
            <div className="bg-primary/10 text-primary font-medium rounded-full px-6 py-2 mb-6">
              Nền tảng đặt sân thể thao #1 Việt Nam
            </div>

            <h1 className="text-4xl md:text-5xl lg:text-6xl text-center text-surface-on font-bold mb-6 max-w-4xl">
              {heroSectionData.title}
            </h1>

            <p className="text-base md:text-lg text-center text-surface-onVariant max-w-2xl mb-12 leading-loose">
              {heroSectionData.subtitle}
            </p>

            {/* Tìm kiếm sân */}
            <div className="w-full max-w-4xl bg-surface-1 p-6 rounded-3xl shadow-navigation border border-outline-variant">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    className="bg-surface border border-outline-variant text-surface-on rounded-lg block w-full pl-10 p-3 focus:ring-2 focus:ring-primary focus:border-primary"
          ...
          <div className="my-12 md:my-20">
            <h2 className="text-3xl md:text-5xl text-center text-surface-on font-bold mb-10 lg:mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {homePopularSports.map((sport) => (
                <div
                  key={sport.id}
                  className="flex flex-col items-center bg-surface-1 rounded-3xl p-6 border border-outline-variant hover:shadow-navigation transition-all hover:-translate-y-1 cursor-pointer"
                >
                  <div
          ...
          {/* Tính năng nổi bật */}
          <div className="my-12 md:my-20 bg-surface-1 py-12 px-6 md:p-16 rounded-3xl">
            <h2 className="text-3xl md:text-5xl text-center text-surface-on font-bold mb-10 lg:mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {homeFeatures.map((feature) => (
                ...
                >
                  <div className="bg-primary-container p-4 rounded-full mb-4">
          ...
          <div className="my-12 md:my-20">
            <h2 className="text-3xl md:text-5xl text-center text-surface-on font-bold mb-2">
              Sân Thể Thao Nổi Bật
            </h2>
            <p className="text-center text-surface-onVariant mb-10 leading-loose">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {homeFeaturedFields.map((field) => (
                <div
                  key={field.id}
                  className="bg-surface-1 rounded-3xl overflow-hidden border border-outline-variant hover:shadow-xl transition-all hover:-translate-y-1 group relative h-80"
                >
                  <img
                    src={field.image}
                    alt={field.name}
            ...
            <div className="flex justify-center mt-8">
              <button className="bg-transparent border border-primary text-primary py-2 px-6 rounded-lg font-medium hover:bg-primary/10 transition-colors">
                Xem tất cả sân
              </button>
            </div>
          </div>
