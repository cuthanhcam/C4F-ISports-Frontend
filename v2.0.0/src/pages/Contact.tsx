        ...
        <div className="relative container py-6 z-[0]">
          ...
          <div className="mt-[142px] md:mt-[162px] lg:mt-[182px]">
            ...
            <div className="my-12 md:my-20">
              <div className="max-w-4xl mx-auto flex flex-col items-center gap-4 border border-outline-variant dark:border-dark-outline-variant p-8 rounded-3xl shadow-navigation dark:shadow-navigation-dark">
              ...
              <div className="max-w-4xl mx-auto border border-outline-variant dark:border-dark-outline-variant p-10 rounded-3xl shadow-navigation dark:shadow-navigation-dark">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex justify-end">
                    <button
                      type="submit"
                      className="bg-primary dark:bg-dark-primary px-8 py-2 rounded-3xl font-medium hover:bg-primary-inverse dark:hover:bg-dark-primary-shade duration-200 transition-all ease-in-out text-surface-on dark:text-dark-primary-on"
                    >
                      Submit
                    </button>
                  </div>
