        ...
        <div className="border border-surface-4 dark:border-dark-outline-variant rounded-3xl w-full max-w-lg text-surface-on dark:text-dark-surface-on">
          <div className="max-w-lg flex flex-col items-start gap-4 p-6">
            ...
            <div className="relative w-full group">
              ...
              />
              <button className="absolute top-1/2 -translate-y-1/2 right-0 text-su dark:text-dark-primary-on text-base font-bold px-4 py-2 
              rounded-full bg-primary dark:bg-dark-primary hover:bg-primary-inverse dark:hover:bg-dark-primary-shade hover:no-underline duration-200 transition-all ease-in-out">
                Get started
              </button>
            </div>
          </div>
