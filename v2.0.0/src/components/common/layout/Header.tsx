      ...
      <div className="container py-6 flex items-center justify-between">
        ...
        <div className="flex items-center lg:gap-6">
          <div className="text-surface-on dark:text-dark-surface-on flex items-center">
            {/* Help me */}
            <button className="hidden lg:block text-xl text-primary dark:text-dark-primary px-3.5 py-1 rounded-md hover:text-primary-tint dark:hover:text-dark-primary-on hover:bg-primary dark:hover:bg-dark-primary duration-200 transition-transform">
           ...
           {/* Dark mode toggle with dropdown */}
            <div className="relative group">
              <button
                ...
                className="flex items-center gap-1 text-xl text-primary dark:text-dark-primary px-3.5 py-1 rounded-md hover:text-primary-tint dark:hover:text-dark-primary-on hover:bg-primary dark:hover:bg-dark-primary duration-200 transition-transform"
              ...
              >
                <div className="px-4 py-2.5 flex flex-col items-start gap-2 w-full">
                  <button
                    ...
                    hover:bg-primary dark:hover:bg-dark-primary hover:text-primary-tint dark:hover:text-dark-primary-on rounded-md transition-colors duration-200 ease-in-out"
                  >
            ...
            {/* Translation */}
            <button className="flex items-center gap-1 text-xl text-primary dark:text-dark-primary px-3.5 py-1 rounded-md hover:text-primary-tint dark:hover:text-dark-primary-on hover:bg-primary dark:hover:bg-dark-primary duration-200 transition-transform">
          ...
          {token ? (
            <div className="relative group">
               <button className="text-xl text-primary dark:text-dark-primary px-3.5 py-1 rounded-md hover:text-primary-on dark:hover:text-dark-primary-on hover:bg-primary dark:hover:bg-dark-primary duration-200 transition-transform">
                  <div className="flex items-center gap-2">
                    <img 
              ...
              <div className="w-[180px] absolute top-full right-0 hidden group-hover:block bg-surface-3 dark:bg-dark-surface-3 text-sm rounded z-[10]">
                <div className='px-4 py-2.5 flex flex-col items-start gap-4 w-full'>
                  <Link 
                    ...
                    hover:bg-primary dark:hover:bg-dark-primary hover:text-primary-on dark:hover:text-dark-primary-on rounded-md transition-colors duration-200 ease-in-out"
                  >
